...
from .views import NurseDashboardView, ListAdmissionRequestsView, ConfirmAdmissionView, ListVitalSignsRequest, ProcessVitalSignsRequestView, ListAppointmentsView, AssignAppointmentToDoctorView
